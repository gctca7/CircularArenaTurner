function ArenaInfo = ArenaSetupAutomatic();
...
% IMPROVEMENTS
% - Find the arena center using the middle spot of the arena exhaust.
% Reject circles that don't have that center point
...
for ExptIdx = 1:length(ExptName)
    ...
    % pause(0.5) % Slow down execution so gcf is accurate
